...
def download_and_preprocessing_ERA5_data(download_ERA5_options):
    ...
    file_name_1st = download_ERA5_options['work_dir'] + download_ERA5_options['name_var'] + '_' + str(start_year) + '_' + str(middle_year) + '.nc'
    ...
    file_name_2nd = download_ERA5_options['work_dir'] + download_ERA5_options['name_var'] + '_' + str(middle_year + 1) + '_' + str(end_year) + '.nc'
